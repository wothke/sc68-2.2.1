...
{
#ifdef EMSCRIPTEN
	// ditch config loading and use hardcoded
	
	(*conf)[SC68config_get_id("version")]= 0;
	(*conf)[SC68config_get_id("sampling_rate")]= 44100;	// unused since it's set on the "api" level
	(*conf)[SC68config_get_id("amiga_blend")]= 43690;
	(*conf)[SC68config_get_id("force_track")]= 1;
	(*conf)[SC68config_get_id("skip_time")]= 4;
	(*conf)[SC68config_get_id("default_time")]= 180;
	(*conf)[SC68config_get_id("total_time")]= 0;
